...
<body>
    ...
    <div id="content" style="display: flex;">
        ...
        <div id="content_box_wrap">
            <h1 style="text-indent: 50px;">자료실<span style="font-size:0.5em;color:gray"> - 추가하기</span></h1>
            <br>
            <br>
            <hr>
            <br>
        ...
        <?php if(isset($_SESSION["id"])){ ?>
            ...
            <form name="frm1" enctype="multipart/form-data" method="post" action="inc_write_ok.php">
                <table class="notice_table">
                    <tr>
                        <th>글 제목</th>
                        <td><input type="text" name="title" class="notice_text_bar" placeholder="제목을 입력하세요"></td>
                    </tr>
                    <tr>
                        <th>작성자</th>
                        <td><input type="text" name="writer" readonly value="<?php echo $_SESSION["id"]?>" class="notice_text_bar"></td>
                    </tr>
                    <tr>
                        <th>첨부파일</th>
                        <td><input type="file" name="usfile"></td>
                    </tr>
                    <tr>
                        <th>내용</th>
                        <td>
