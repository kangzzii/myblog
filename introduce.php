    ...
    <div id="content" style="display: flex;">
        ...
        <div id="content_menu">
            <div class="content_menu_title">
                About Me<br>
                <span style="font-size: 0.8em;color: #eee;"> &#8618; Introduce</span>
            </div>
        ...
        <div id="content_box_wrap">
            <h1 style="text-indent: 50px;">프로필</h1>
            <br>
            <hr>
            <br>
            <div id="introduce">
                ...
                <ul class="introduce_box">
                    <li>
                        <div class="introduce_title" style="background-color: seagreen;">이름</div>
                        강지연 &emsp; Jeeyeun Kang &emsp; 姜知延
                    </li>
                    <li>
                        <div class="introduce_title">출생</div>
                        부산광역시, 1994년 3월 생
                    </li>
                    <li>
                        <div class="introduce_title" style="background-color: seagreen;">학력</div>
                        경성대학교 중국어통번역학과 졸업
                    </li>
                    <li style="line-height: 30px;">
                        <div class="introduce_title">경력</div>
                         ˚ 그랜드 코리아 레저 인턴<br>
                         &emsp;&emsp;˚ 중국비자서비스 센터 근무<br>
                    </li>
                </ul>
            </div>
        </div>
