...
<body>
    ...
    <div id="content" style="display: flex;">
        ...
        <div id="content_box_wrap">
            <h1 style="text-indent: 50px;">자유 게시판</h1>
            <!-- 게시판 추가 버튼 -->
            <?php
            if(isset($_SESSION["id"])){
            ?>
            <div class="notice_add_bt" onclick="location.href='board_write.php'">게시판 글작성</div>
            <?php }?>
            <!-- 게시판 추가 버튼 끝 -->
            <br>
            <hr>
            ...
            <table class="notice_table1">
                ...
                $startrow=($page-1)*10;
                $sql="select * from board order by no desc limit $startrow,10";
                $rs=mysqli_query($conn,$sql);
                $all_sql="select count(*) as cnt from board";
                ...
                <tr>
                    ...
                    if($group>1){
                        ...
                        echo "<a href='board.php?page=$prevpage'>이 전</a> &nbsp;";
                    }
                    ...
                    for($i=$startpage;$i<=$endpage;$i++){
                        ...
                        if($i==$page){
                            echo  "<a href='board.php?page=$i'style='font-weight:bold;'> < <font color='red'>$i</font> > </a>";
                        }else{
                    ?>
                    ...
                    <?php } }
                        if($group<$pagegroup){
                            $nextpage=$group*5+1;
                            echo "<a href='board.php?page=$nextpage'>&nbsp;다 음</a>";
                        }
                    ?>
                    </td>
                </tr>
