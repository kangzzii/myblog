            ...
            <form name="frm1" method="post" action="notice_write_ok.php">
                ...
                <table class="notice_table">
                    ...
                    <tr style="border-bottom:none">
                        <td colspan="2">
                            <input type="button" onclick="location.href='notice.php'" value="돌아가기" class="notice_upload_bt">
                            <!-- 수정 삭제는 관리자만 -->
                            <?php if(isset($_SESSION["id"])){
                                    if($_SESSION["id"]=="admin"){
                            ?>
                            <input type="button" value="삭제" onclick="del_notice()" class="notice_reset_bt">
                            <input type="button" onclick="location.href='notice_edit.php?no=<?php echo $no?>'" value="수정" class="notice_upload_bt">
                            <?php } }?>
                            <!-- 수정 삭제는 관리자만 끝 -->
                        </td>
                    </tr>
                    ...
                    <script>
                        function del_notice(){
                            if(confirm("정말로 삭제하시겠습니까?")){
                                location.href="notice_del.php?no=<?php echo $no?>"
                            }
                        }
                    </script>
                    <!-- 삭제 스크립트 끝 -->
