...
<body>
    ...
    <div id="content" style="display: flex;">
        ...
        <div id="content_box_wrap">
            ...
            <!-- qna 시작 -->
            <div id="qna_wrap">
                <form name="qna_frm" method="post" action="qna_edit_ok.php">
                    <!-- qna불러오기 -->
                    <?php
                    $no=$_GET["no"];
                    ...
                    <table class="qna_table">
                        ...
                        <tr>
                            <td>글제목</td>
                            <td>
                                <input type="text" name="title" required class="qna_text" value="<?php echo $row["title"]?>" placeholder="글제목을 입력하세요.">
                            </td>
                        </tr>
                        <tr>
                            <td>내용</td>
                        ...
                        <tr>
                            <td colspan="2">
                                ...
                                <input type="submit" value="수정완료" class="qna_bt">
